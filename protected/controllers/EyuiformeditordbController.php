...
class EyuiformeditordbController extends Controller
{
	/**
...
public function   init() {
  ...
  private function registerAssets(){
	...
	{
		$model=Eyuiformeditordb::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='eyuiformeditordb-form')
		{
        ...
        $this->renderPartial('view',array('model'=>$model),false, true);
             ...
             if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new Eyuiformeditordb;
		...
		$model=new Eyuiformeditordb('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Eyuiformeditordb']))
			$model->attributes=$_GET['Eyuiformeditordb'];
		...
		if(isset($_POST['Eyuiformeditordb']))
		{
           $model=$this->loadModel($_POST['update_id']);
			$model->attributes=$_POST['Eyuiformeditordb'];
			if( $model->save(false)){
